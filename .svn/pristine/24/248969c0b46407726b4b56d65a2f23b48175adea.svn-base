...
public class Constants {
    ...
    public static final String KEY_MAP_USERNAME = "_KEY_MAP_USERNAME_";
    public static final String KEY_MAP_AUTHORITY = "_KEY_MAP_AUTHORITY_";
    ...
    //返回的json数据的key
    public static final String KEY_JSON_QUESTION = "question";//返回的json中的key
    //获取前台数据的key
